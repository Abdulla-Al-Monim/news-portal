            ...
            <div class="row">
                ...
                <div class="col-md-8">
                  <?php
                      ...
                      $totalPost        = mysqli_num_rows($readCategoryPost);
                      if ($totalPost == 0){
                        ?>
                        <div class="alert alert-warning">
                            <h1>Opps!No post In this category</h1>
                        </div>
                        <?php
                      }
                      else{
                                ...
                                <h3 class="post-title"><?php echo $title; ?></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 read-more-btn">
                                            <a href="single.php?post_id=<?php echo $post_id; ?>" class="btn-main">Read More <i class="fa fa-angle-double-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>   
